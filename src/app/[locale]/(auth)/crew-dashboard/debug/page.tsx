    ...
    <div className="space-y-6 rounded-lg bg-white p-6">
      ...
      <div className="space-y-4">
        <div className="rounded-lg bg-blue-50 p-4">
          <h2 className="mb-2 font-semibold">{t('user_info')}:</h2>
          <p className="text-sm">
        ...
        <div className="rounded-lg bg-green-50 p-4">
          <h2 className="mb-2 font-semibold">{t('crew_id_clerk')}:</h2>
          {crewId ? (
            <div className="space-y-2">
              {crewIdRaw !== crewId && (
                <>
                  <p className="text-xs text-orange-600">
                    ⚠️ {t('original_no_hyphens')}:
                    {' '}
                    <code>{crewIdRaw}</code>
                  </p>
              ...
              {crewIdRaw === crewId && (
                <p className="break-all text-sm font-mono">{crewId}</p>
              )}
              {matchingCrew ? (
            ...
            <p className="text-sm text-red-600">❌ {t('no_crew_id')}</p>
          )}
        </div>

        <div className="rounded-lg bg-purple-50 p-4">
          <h2 className="mb-2 font-semibold">{t('available_crews')}:</h2>
          <div className="space-y-2">
            {allCrews.map(crew => (
        ...
        <div className="rounded-lg bg-yellow-50 p-4">
          <h2 className="mb-2 font-semibold">{t('action_required')}:</h2>
          {!matchingCrew && crewId && (
